...
button_9 = Button(window,text="9",padx=91,pady=20,command=lambda:button_click(9))
button_0 = Button(window,text="0",padx=79,pady=20,command=lambda:button_click(0))

button_add = Button(window,text="+",padx=39,pady= 20,command=button_add)
button_equals = Button(window,text="=",padx=39,pady= 20,command=button_equal)
button_clear = Button(window,text="Clear",padx=39,pady= 20,command=button_clear)
button_sub = Button(window,text="-",padx=39,pady= 20,command=button_sub)
button_multi = Button(window,text="*",padx=39,pady= 20,command=button_multi)
button_divide = Button(window,text="/",padx=39,pady= 20,command=button_divide)
